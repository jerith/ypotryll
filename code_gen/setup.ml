...
(* OASIS_START *)
(* DO NOT EDIT (digest: 105e9aaaf6261255df1b9378e535f458) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ypotryll_code_gen", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "update_mllib.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\021\166~\232\155\128T\222yW[^\133p\219~";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
