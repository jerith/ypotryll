...
(* OASIS_START *)
(* DO NOT EDIT (digest: adfab9a9fb7bd33cec0d909e4e731eaf) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/jerith/ypotryll";
          synopsis = "AMQP client library";
          description = Some [OASISText.Para "AMQP client library"];
          categories = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules =
                        [
                           "Ypotryll_field_types";
                           "Ypotryll_types";
                           "Ypotryll";
                           "gen/Ypotryll_methods";
                           "gen/Ypotryll_contents"
                        ];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           "Parse_utils";
                           "Protocol";
                           "gen/Generated_method_types";
                           "gen/Generated_frame_constants";
                           "Frame";
                           "Connection";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\139B\019h)\204g!Y}\167\183\023#\240\162";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
