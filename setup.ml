...
(* OASIS_START *)
(* DO NOT EDIT (digest: da8beb58e6b4da69ff6fdf2a7ca0ce51) *)
(*
...
let setup_t =
  {
     ...
     test =
       [
          ("test_ypotryll_code_gen",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$test_ypotryll_code_gen", ["-q"]))
                   ];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Amqp_spec"; "Spec_parser"; "Module_builder"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "ypotryll_code_gen"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "code_gen.ml"});
               Library
                 ({
                     cs_name = "ypotryll_proto";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Parse_utils"; "Protocol"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib/gen";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ypotryll_proto"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "ypotryll_gen_code"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "foo.ml"});
               Executable
                 ({
                     cs_name = "test_ypotryll_code_gen";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "code_gen_test";
                      test_run =
                        [
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some ";\193D\224D\143\001QC\205\138\007\157g\250\151";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
