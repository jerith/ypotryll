...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2c93ee223801652e47a6f627cef289b7) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ypotryll", []))];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Generated_method_types"; "Generated_methods"];
                      lib_pack = false;
                      lib_internal_modules = ["Stubs"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "3\137\154\b\234\174q\194\158\239\018\203-s\212G";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
